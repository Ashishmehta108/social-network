...
export default function Register() {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-300 flex flex-col items-center justify-center gap-4 py-12">
      ...
      <form
        onSubmit={handleForm}
        className="w-[80%] sm:w-[65%] md:w-[55%] lg:w-[35%] bg-white px-4 py-8 flex-col items-center rounded-md"
      >
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <button
            type="button"
            className="text-sm py-1 px-3 text-blue-700 font-semibold rounded-md border-[1px] border-blue-700"
